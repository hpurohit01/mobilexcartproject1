package com.mobilexcart.utility;


import com.google.common.base.Function;
import com.mobilexcart.drivermanager.DriverManager;
...
/*    // NOTE: This method needs to be revised due to Assert from jUnit and Maven are going to be different . check import before moving on with this method.
    ...
    // the expected condition waits for an element to be clickable i.e. it shoould be present/displayed/visible on the screen as well as enabled
